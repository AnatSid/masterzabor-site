...
export const services: Service[] = [
  ...
  },
  {
    ...
    metaTitle: "Заборы из евроштакетника в Гомеле — цена и монтаж",
    metaDescription:
      "Установка заборов из евроштакетника в Гомеле и Беларуси от 85 BYN/м.п. Аккуратный вид, вентиляция участка, гарантия.",
    priceFrom: 85,
    priceUnit: "BYN/м.п.",
    description:
      "Евроштакетник выглядит легче сплошного забора, пропускает воздух и сохраняет аккуратный фасад участка. Доступна односторонняя и шахматная зашивка.",
    features: [

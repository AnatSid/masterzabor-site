...
> ворота или калитка. По этим данным назовём ориентировочную стоимость по телефону.
...
> начала работ согласуем комплектацию, выезд, доставку, сроки и стоимость. Всё
> это фиксируем в смете и договоре, там же прописываем гарантийные условия.
> Ориентиры по стоимости можно посмотреть на странице
> [цен на заборы](/tseny).
